...
Usage:
    python scripts/06_test_published_agent.py
    python scripts/06_test_published_agent.py -q "大阪出張の日当は？"
"""
...
BASE_URL = os.environ.get(
    "AGENT_APP_BASE_URL",
    "https://ai-eval-qvjy4lzdgqoci.services.ai.azure.com"
    "/api/projects/foundry-agent-eval"
    "/applications/travel-expense-helpdesk/protocols/openai",
)
