...
Usage:
    python scripts/05_create_eval_completeness_only.py
    python scripts/05_create_eval_completeness_only.py --eval-name my-eval
    python scripts/05_create_eval_completeness_only.py --agent-name my-agent
"""
