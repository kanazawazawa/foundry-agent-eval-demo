...
結果は Actions の **Summary** タブにレポートとして出力され、Pass Rate が 100% 未満の場合は GitHub Issue が自動作成され、Copilot Coding Agent が自動アサインされます。
Coding Agent が Issue の内容からバグを特定し、修正 PR を Draft で作成します。
